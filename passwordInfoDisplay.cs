...
namespace WinFormsApp1
{
    ...
    public class PasswordInfoDisplay : FlowLayoutPanel
    {
        ...
        public PasswordInfoDisplay(MainWindow form)
        {
            ...
            //Alignment for copybutton, must be done after controls addto get accurate width readings
            //Later
        ...
        private void InitUsernamePanel()
        {
            ...
            CopyUserButton.Margin = new Padding(10, 0, 0, 0);
        ...
        private void InitPasswordPanel()
        {
            ...
            Password.MaximumSize = new Size(Percent20, 400000);
            ...
            CopyPassButton.Margin = new Padding(10, 0, 0,0);
